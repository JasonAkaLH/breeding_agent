...
class SQLQuerySQLExecuteReadonlyCapability(CapabilityContract):
    ...
    async def execute(self, request: CapabilityExecutionRequest) -> CapabilityExecutionResult:
        ...
        output = {
            ...
            "entities": list(upstream.get("entities", [])),
            "probe_summary": upstream.get("probe_summary"),
            "match_summary": upstream.get("match_summary"),
            "matched_fields": list(upstream.get("matched_fields", [])),
            "match_tiers": list(upstream.get("match_tiers", [])),
            "search_effort_summary": upstream.get("search_effort_summary"),
            "query_constraints": upstream.get("query_constraints"),
            "constraint_coverage_summary": upstream.get("constraint_coverage_summary"),
