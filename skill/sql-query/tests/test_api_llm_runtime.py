...
def _reasoning_efforts() -> dict[str, Any]:
    return {
        "default": "minimal",
...
def _main_agent_llm_config(model: str = "fake-main") -> dict[str, Any]:
    return {
        "api_key": "test",
        ...
        "model_editions": {
            "default": model,
            "options": [
                {"value": model, "label": model, "reasoning_efforts": _reasoning_efforts()},
            ],
        },
    }
...
class SQLQueryLLMRuntimeAPITest(SQLQueryAPITestCase):
    async def test_sqlquery_skill_uses_main_agent_provider_adapter(self) -> None:
        ...
        await self.reconfigure_runtime(
            ...
            main_agent_llm_config=_main_agent_llm_config(),
        ...
        await self.reconfigure_runtime(
            ...
            main_agent_llm_config={
                ...
                "model_editions": {
                    "default": "flash",
                    "options": [
                        {"value": "flash", "label": "Flash", "reasoning_efforts": _reasoning_efforts()},
                        {"value": "pro", "label": "Pro", "reasoning_efforts": _reasoning_efforts()},
                    ],
                },
            },
            main_agent_llm_client_factory=FakeMainAgentLLMClient,
