...
- 前端 Slash Skill Command 设计：新增 `docs/superpowers/specs/2026-05-20-frontend-slash-skill-command-design.md`，明确 `/skill-name` 强制 Skill 路由、无 slash 自动规划、上传文件 metadata 合并、信息不足 pending Skill context 续接与前后端测试切分。
