...
注入来源：`configs/nl2sql/routing_rules.yaml`
...
注入来源：`configs/nl2sql/schema_metadata.yaml`
...
注入来源：
- `configs/nl2sql/sql_guard_rules.yaml`
- `configs/nl2sql/routing_rules.yaml` 中的 `sql_policy_profile`
