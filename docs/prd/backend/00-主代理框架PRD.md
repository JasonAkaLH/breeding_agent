...
- 统一同模型 Agent Loop 分阶段 PRD：`docs/prd/backend/unified-agent-loop/README.md`（总纲与8篇阶段PRD逐篇100/100、实施计划99/100通过；Phase 0已proof_complete；Phase 6完成前当前DAG仍是已实现运行时基线）。
