...
| `tests/orchestration/test_public_contract_compatibility.py` | `main_agent.respond` | `migrate_behavior` | `UA-P6` | `Phase 6` | `rewritten` | `conda run -n multi_agent python scripts/validate_unified_agent_loop_evidence.py --phase 6 --require-closed` |
