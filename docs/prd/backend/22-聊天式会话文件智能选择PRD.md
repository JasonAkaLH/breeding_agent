...
```bash
python /Users/yinpeihai/.codex/skills/.system/skill-creator/scripts/quick_validate.py /path/to/breeding-skill-builder
...
7. `git@gitee.com:biobin/breeding-skill-builder.git` 的 `references/Skill构建指南.md` 同步更新，未来 Skill 模板默认符合新平台流程。
