...
| `docs/prd/backend/unified-agent-loop/` | 统一同模型Agent Loop总纲与Phase 0～7实施依赖PRD：Model Contract、Agent Storage/Lease、Invocation/Skill/MCP、核心Loop、Continuation、API/Frontend、Clean Cutover和破坏性Schema删除 | 总纲与8篇阶段PRD逐篇100/100、实施计划99/100通过；Phase 0进行中，P0-A green |
