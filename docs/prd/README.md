...
| `docs/prd/backend/skill-contract-progressive-disclosure/` | Skill Contract 渐进式披露、显式 skill.* 执行、input schema、ResourceService 与 legacy auto_run 兼容边界 | 设计确认；待实施计划拆解 |
