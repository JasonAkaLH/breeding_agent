...
| `docs/prd/backend/skill-workbench/` | Skill 运行闭环 Workbench 分步 PRD：Policy/runtime state、内部 capability/executor、runtime loop/finalizer、事件 graph prompt 脱敏、contract quality diagnostics | 已拆分 runtime replan 主线；待实施 |
