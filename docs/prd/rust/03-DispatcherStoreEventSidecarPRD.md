...
- 当前实现仍是 contract/kernel + Python facade / client 消费基线，不代表 shadow/enforce promotion、artifact provenance allowlist 或 Python 写路径最终下线已经完成。
