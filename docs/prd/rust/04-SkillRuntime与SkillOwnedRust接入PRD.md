...
- **日期**：2026-05-14
- **来源基线**：`docs/prd/backend/16-Rust化Runtime模块评估PRD.md` RUST-P0-005、RUST-P0-006、RUST-P1-004、8.2.3、9.4、9.7；`.codex/skills/breeding-skill-builder/`
...
Rust metadata 示例必须与 `.codex/skills/breeding-skill-builder/` 保持一致：
