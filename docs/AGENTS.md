...
| PRD | 状态 | 后续动作 |
|---|---|---|
| `prd/backend/unified-agent-loop/README.md`（来源：统一Agent Loop架构与PRD decomposition design） | Phase 0～Phase 4 `proof_complete`；P5-A green | 进入P5-B Frontend、多waiting、可访问性与cutover readiness；保持Phase 6前当前DAG运行时不变。 |
