...
| `superpowers/specs/2026-08-18-mcp-dispatch-aggregate-recovery-hardening-design.md` | 通过95%文档信心门；尚未实施 | 按 Phase 0～4先修复CP7时间、durable result与post-admission收敛，再统一聚合事务、32 MiB加密审批action、MRTR/remote恢复、claim/预算、30天candidate archive/GC及result lifecycle，并完成17个崩溃边界的SQLite/PostgreSQL故障注入。 |
