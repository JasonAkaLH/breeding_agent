...
| PRD | 状态 | 后续动作 |
|---|---|---|
| `superpowers/specs/2026-07-15-personal-desktop-long-task-agent-design.md` | 总体设计已确认；实现尚未开始 | 基于该设计生成分阶段实施计划；个人版以 Rust daemon 为唯一可信控制 runtime，一次性替换服务端架构，旧历史只读导入。 |
