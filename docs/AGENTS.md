...
- `superpowers/specs/2026-08-26-p0-data-flow-hard-defect-repair-design.md`：已批准方案A并以96/100完成书面自审的四项P0硬伤手术式修复设计；Checkpoint B当前lease提交与C remote terminal单向约束已完成，A因SQL/Sidecar双authority事实暂停；三项P1和其他deferred behavior仍明确排除。
