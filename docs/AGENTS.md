...
- `superpowers/specs/2026-08-26-p0-data-flow-hard-defect-repair-design.md`：已批准方案A并以96/100完成书面自审的四项P0硬伤手术式修复设计；Checkpoint B当前lease提交已完成，A因SQL/Sidecar双authority事实暂停，C待实施；三项P1和其他deferred behavior仍明确排除。
...
| `superpowers/specs/2026-08-26-p0-data-flow-hard-defect-repair-design.md` | 方案A已批准；Checkpoint B已实施，A因Task enforce写Sidecar而Conversation/Message写SQL的双authority事实暂停，C待实施 | 先完成独立Checkpoint C；A必须回到authority设计门，未经批准不得以跨系统半提交或暗写SQL Task冒充原子性。三项P1、schema/proto、Frontend和`prod`仍不在当前实施范围。 |
