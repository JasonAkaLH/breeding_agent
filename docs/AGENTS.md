...
- `superpowers/specs/2026-08-17-public-http-user-mcp-endpoint-policy-design.md`：用户级 MCP 允许任意公网 HTTP/HTTPS、自定义端口与 HTTP 凭据；公网 HTTP 由前端一次确认，私网/特殊地址及 DNS/重定向防护继续强制，管理员 Endpoint 白名单待移除。
