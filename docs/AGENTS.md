...
- `superpowers/specs/2026-08-25-project-wide-progressive-architecture-cleanup-p6-implementation-plan.md`：基于P5 handoff与`e49a039` HEAD启动的P6 Frontend边界计划；只复用pure Set helper并分离Attachment/Interrupt pure domain与presentational components；App-local upload/answer/Task Runtime effects、wire、DOM/a11y与307项基线不动。
...
| `superpowers/specs/2026-08-25-project-wide-progressive-architecture-cleanup-p6-implementation-plan.md` | P6实施`active`；Frontend 307项/typecheck/build baseline、1组exact duplicate与App/domain/component owner已审计 | 按A～E只做pure helper和Attachment/Interrupt无effect分层；不移动App controller或改UI/wire。 |
