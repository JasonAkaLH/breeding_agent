...
- `superpowers/specs/2026-08-26-p0-data-flow-hard-defect-repair-design.md`：已批准方案A并以96/100完成书面自审的四项P0硬伤手术式修复设计；仅覆盖原子Conversation/Message/Task准入、Message ID冲突/精确重放、Agent heartbeat当前lease提交和remote terminal单向约束，拆为三个独立检查点，不纳入三项P1或其他deferred behavior。
...
| `superpowers/specs/2026-08-26-p0-data-flow-hard-defect-repair-design.md` | 方案A已批准，书面设计96/100通过自审；代码尚未实施 | 用户复审书面规格后，另立只含Checkpoint A～C的实施计划；不得混入三项P1、schema/proto、Frontend或`prod`变更。 |
