...
| PRD | 状态 | 后续动作 |
|---|---|---|
| `prd/backend/unified-agent-loop/README.md`（来源：统一Agent Loop架构与PRD decomposition design） | Phase 0 `in_progress`；P0-A inventory/evidence/baseline green；P0-B未开始 | 按计划进入P0-B Agent Model contract/adapter/edition gate；Phase 0退出前不开始Agent storage。 |
