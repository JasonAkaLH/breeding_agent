...
class SQLQueryLLMRuntimeAPITest(APITestCase):
    async def test_sqlquery_skill_uses_main_agent_provider_adapter_not_dedicated_sqlquery_client(self) -> None:
        main_calls: list[dict[str, Any]] = []
        sql_client_inits: list[dict[str, Any]] = []
        ...
        class FakeDedicatedSQLQueryLLMClient:
            def __init__(self, **kwargs: Any) -> None:
                sql_client_inits.append(dict(kwargs))
        ...
        await self.reconfigure_runtime(
            ...
            sql_query_llm_client_factory=FakeDedicatedSQLQueryLLMClient,
        ...
        self.assertEqual(sql_client_inits, [])
