...
class Scheduler:
    ...
    def select_instance(self, capability_id: str) -> ExecutionInstance:
        candidates = [
            ...
            if capability_id in instance.supported_capabilities and instance.state == InstanceState.ONLINE
        ]
        if not candidates:
            raise NoAvailableInstanceError(f"No online instance supports capability {capability_id}.")
