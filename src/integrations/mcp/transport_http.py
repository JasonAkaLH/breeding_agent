...
from .protocol import MCPStreamEvent, MCPTransportResponse, json_rpc_message_kind
...
class StreamableHTTPTransport:
    ...
    async def send(
        ...
        *,
        ...
        headers = self._post_headers(protocol_version=protocol_version, session_id=session_id, last_event_id=last_event_id)
        try:
        ...
        return _response_from_http(response, session_id=session_id)
    ...
    def _post_headers(self, *, protocol_version: str, session_id: str | None, last_event_id: str | None) -> dict[str, str]:
        headers = {
...
def _response_from_http(response: httpx.Response, *, session_id: str | None, require_sse: bool = False) -> MCPTransportResponse:
