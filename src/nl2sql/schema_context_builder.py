...
class SchemaContextBuilder:
    """Builds a trimmed NL2SQL schema context from static route/schema metadata only."""
    ...
    def _load_yaml(path: str | Path) -> Mapping[str, Any]:
        try:
            ...
            raise RuntimeError("PyYAML is required to load NL2SQL YAML configuration files.") from exc
