...
class NL2SQLIntentRouteCapability(CapabilityContract):
    capability_id = "nl2sql.intent_route"
    version = "1"
    description = "Detect whether the request belongs to an NL2SQL route and collect minimal routing context."

    def __init__(self, *, routing_rules_path: str | None = None) -> None:
        self._routing_rules_path = routing_rules_path or str(repo_root() / "configs/nl2sql/routing_rules.yaml")
