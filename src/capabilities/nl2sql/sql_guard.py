...
class NL2SQLSQLGuardCapability(CapabilityContract):
    ...
    def __init__(self, *, routing_rules_path: str | None = None, guard_rules_path: str | None = None) -> None:
        ...
        guard_path = guard_rules_path or str(repo_root() / "configs/nl2sql/sql_guard_rules.yaml")
    ...
    async def execute(self, request: CapabilityExecutionRequest) -> CapabilityExecutionResult:
        ...
        event = self._make_event(request, event_type="nl2sql.sql_guard_passed", payload={"status": "passed"})
        return CapabilityExecutionResult(
            capability_id=request.capability_id,
            task_id=request.task_id,
            node_id=request.node_id,
